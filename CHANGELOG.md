...
- Their 7 info items never age out on their own; they leave the desk only when they toggles read. That is by design, but it is what made the DONE fault permanent, so a "fold info older than N days into History" rule would stop the shape recurring.
